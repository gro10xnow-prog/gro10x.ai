/**
 * scripts/e2e-client/utils.js
 * Shared Utilities, Assertions, and Browser Setup for Client Partner E2E Test Suite
 */
...
const PARTNERS_URL = `${BASE_URL}/partners`;
const CLIENT_SPA_URL = `${BASE_URL}/client/index.html`;
