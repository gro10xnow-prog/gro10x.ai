...
const defaultCMSContent = {
  ...
  portfolioShowcase: [
    { id: "PORT-001", title: "LG Electronics Bangladesh", subtitle: "3+ Years Retainer • Digital Branding & 500k+ Audience Growth", category: "Electronics & Tech", metric: "📱 500,000+ Social Community", image: "/images/portfolio/lg.jpg" },
    { id: "PORT-002", title: "InterContinental Dhaka", subtitle: "Official Digital Marketing & 360° Creative Support Agency", category: "Hospitality & Luxury", metric: "🏨 2+ Years Full Content Support", image: "/images/portfolio/intercontinental.png" },
    { id: "PORT-003", title: "United Commercial Bank (UCB)", subtitle: "Annual Financial Report Video & Digital Launch Campaign", category: "Corporate Financial", metric: "💼 100% On-Time Delivery", image: "/images/portfolio/ucb.png" },
    { id: "PORT-004", title: "Chillox Burger Chain", subtitle: "Full Social Media Retainer & Viral Short-Form Video Reels", category: "FMCG & Food", metric: "🍔 2.4M+ Organic Reel Views", image: "/images/portfolio/chillox.png" },
    { id: "PORT-005", title: "Mortein Protection (Reckitt)", subtitle: "Digital TVC Commercial & Social Protection Awareness Campaign", category: "Health & FMCG", metric: "🛡️ 1.8M Campaign Reach", image: "/images/portfolio/mortein.png" },
    { id: "PORT-006", title: "Harpik Hygiene (Reckitt)", subtitle: "National Sanitation Awareness Video Series & Motion Graphics", category: "Home Care & FMCG", metric: "✨ 3.2M Impressions", image: "/images/portfolio/harpic.png" },
    { id: "PORT-007", title: "BAT Global (British American Tobacco)", subtitle: "Corporate Event Digital Motion & Video Retainer", category: "Corporate Enterprise", metric: "⚡ Executive Asset Delivery", image: "/images/portfolio/bat.png" },
    { id: "PORT-008", title: "Taptap Send Remittance App", subtitle: "Bangladesh Market Launch & User Acquisition Campaign", category: "Fintech & Mobile", metric: "💸 +45% App Installs", image: "/images/portfolio/taptap.png" },
    { id: "PORT-009", title: "Yatai Japanese Dining", subtitle: "Restaurant Launch & Authentic Japanese Food Social Reels", category: "Restaurant & Dining", metric: "🍣 850k Local Reach", image: "/images/portfolio/yatai.png" }
  ],
  pricingPackages: [
